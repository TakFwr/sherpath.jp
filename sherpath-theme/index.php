  ...
  <section id="mission" class="top__section">
    ...
    <div class="mission__contents">
      <div class="mission__text">
        ...
        <p>こうしたジェンダーギャップの背後には、根強く存在している無意識の偏見や性別による役割分担があります。シェルパスではこれを「謎のルール」と呼び、女性の人生に「制限」を引き起こしていると考えています。</p>
      ...
      <div class="service__contents">
        ...
        <div class="service__item">
          ...
          <div class="service__text">
            ...
            <p>しかし、卵子凍結を具体的に検討する際には卵子凍結をするべきか、自分に適した進め方、どのクリニックで行うのが良いかを判断するための情報を入手しづらいのが現状です。</p>
